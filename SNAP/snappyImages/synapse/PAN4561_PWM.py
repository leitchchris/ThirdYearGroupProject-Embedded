...
PAN4561 pin GPIO 14 is connected to pin TPM2C3 of the processor.
PAN4561 pin GPIO 15 is connected to pin TPM2C1 of the processor.
PAN4561 pin GPIO 31 is connected to pin TPM2C2 of the processor.
PAN4561 pin GPIO 32 is connected to pin TPM2C4 of the processor.
...
# A value of 0 will be a 0% duty cycle, a value of modulus+1 = 100%
def setTPM2C2DutyCycleMsbLsb(polarity, valh, vall):
    """
    Sets the duty cycle for the pulse stream on GPIO 31
    'polarity' specifies logic level of first portion of pulse
    'value' specifies width of the first portion, and valid values
    are 0 (0%) to TPM2_MODULUS+1 (100%) but split into two bytes
    """
    if polarity:
        poke(0x6B, 0x28) # Set TPM2C2SC for Edge PWM, High then Low
    else:
        poke(0x6B, 0x24) # Set TPM2C2SC for Edge PWM, Low then High
    poke(0x6C, valh) # Set TPM2C2VH
    poke(0x6D, vall) # Set TPM2C2VL

# See also setTPM2C2DutyCycleMsbLsb(), which this routine uses
def setTPM2C2DutyCycleWord(polarity, value):
    """
    Sets the duty cycle for the pulse stream on GPIO 31
    'polarity' specifies logic level of first portion of pulse
    'value' specifies width of the first portion, and valid values
    ...
    msb = value / 256
    lsb = value % 256
    setTPM2C2DutyCycleMsbLsb(polarity, msb, lsb)
    
# A value of 0 will be a 0% duty cycle, a value of modulus+1 = 100%
def setTPM2C4DutyCycleMsbLsb(polarity, valh, vall):
    """
    Sets the duty cycle for the pulse stream on GPIO 31
    'polarity' specifies logic level of first portion of pulse
    'value' specifies width of the first portion, and valid values
    ...
    """
    if polarity:
        poke(0x71, 0x28) # Set TPM2C4SC for Edge PWM, High then Low
    else:
        poke(0x71, 0x24) # Set TPM2C4SC for Edge PWM, Low then High
    poke(0x72, valh) # Set TPM2C4VH
    poke(0x73, vall) # Set TPM2C4VL

# See also setTPM2C4DutyCycleMsbLsb(), which this routine uses
def setTPM2C4DutyCycleWord(polarity, value):
    """
    Sets the duty cycle for the pulse stream on GPIO 31
    'polarity' specifies logic level of first portion of pulse
    'value' specifies width of the first portion, and valid values
    ...
    msb = value / 256
    lsb = value % 256
    setTPM2C4DutyCycleMsbLsb(polarity, msb, lsb)
